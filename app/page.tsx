  ...
  return (
    <div className="flex flex-col gap-6 h-full">
      ...
      <div className="flex gap-3">
        <Link href="/calls" className="flex items-center gap-2 px-4 py-2.5 bg-[#00ff88]/10 hover:bg-[#00ff88]/20 border border-[#00ff88]/30 rounded-lg text-[#00ff88] text-sm font-semibold transition-all">
          <Phone size={15} />
          New Call
        </Link>
        <Link href="/intel" className="flex items-center gap-2 px-4 py-2.5 bg-white/[0.04] hover:bg-white/[0.07] border border-white/[0.08] rounded-lg text-white text-sm font-medium transition-all">
          <Shield size={15} />
          Inject Intel
        </Link>
        <Link href="/dossiers" className="flex items-center gap-2 px-4 py-2.5 bg-white/[0.04] hover:bg-white/[0.07] border border-white/[0.08] rounded-lg text-white text-sm font-medium transition-all">
      ...
      <div className="flex-1 bg-[#0d0d0d] border border-white/[0.06] rounded-xl overflow-hidden flex flex-col">
        <div className="flex items-center justify-between px-5 py-3.5 border-b border-white/[0.06]">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-semibold text-white">Recent Call Sessions</span>
          </div>
          {stats.activeCalls > 0 && (
